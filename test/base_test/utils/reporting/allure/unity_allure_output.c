                                  ...
                                  double time_ms)
{
    ...
    if (skipped > allure_state_v2.suite_skipped) {
        uint32_t extra_skips = skipped - allure_state_v2.suite_skipped;
        allure_state_v2.suite_tests += extra_skips;
        allure_state_v2.suite_skipped += extra_skips;
    }

    if (allure_state_v2.suite_tests < tests) {
