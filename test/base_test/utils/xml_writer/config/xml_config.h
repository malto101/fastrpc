...
/**
 * @brief Apply the field defaults for an environment profile onto an
 * existing configuration (used internally to keep xml_config_create_for_env()
 * and xml_config_apply_env_overrides() in sync).
 */
